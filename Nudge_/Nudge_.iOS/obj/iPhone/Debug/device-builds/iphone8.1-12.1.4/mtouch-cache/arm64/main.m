...
extern void *mono_aot_module_Nudge__iOS_info;
...
extern void *mono_aot_module_Nudge__info;
extern void *mono_aot_module_Xamarin_Forms_Xaml_info;
extern void *mono_aot_module_Syncfusion_SfListView_XForms_info;
extern void *mono_aot_module_Syncfusion_DataSource_Portable_info;
...
extern void *mono_aot_module_Syncfusion_Buttons_XForms_info;
...
extern void *mono_aot_module_Syncfusion_SfListView_XForms_iOS_info;
extern void *mono_aot_module_Syncfusion_Buttons_XForms_iOS_info;
extern void *mono_aot_module_Syncfusion_Core_XForms_iOS_info;

void xamarin_register_modules_impl ()
{
	mono_aot_register_module (mono_aot_module_Nudge__iOS_info);
	...
	mono_aot_register_module (mono_aot_module_Nudge__info);
	mono_aot_register_module (mono_aot_module_Xamarin_Forms_Xaml_info);
	mono_aot_register_module (mono_aot_module_Syncfusion_SfListView_XForms_info);
	mono_aot_register_module (mono_aot_module_Syncfusion_DataSource_Portable_info);
	...
	mono_aot_register_module (mono_aot_module_Syncfusion_Buttons_XForms_info);
	...
	mono_aot_register_module (mono_aot_module_Syncfusion_SfListView_XForms_iOS_info);
	mono_aot_register_module (mono_aot_module_Syncfusion_Buttons_XForms_iOS_info);
...
void xamarin_setup_impl ()
{
	...
	xamarin_executable_name = "Nudge_.iOS.exe";
	mono_use_llvm = FALSE;
	xamarin_log_level = 0;
